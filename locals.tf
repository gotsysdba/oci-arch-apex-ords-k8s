...
locals {
  #dns_names = toset(["container-registry.oracle.com", "docker.io", "github.io", "quay.io", "registry.k8s.io"])
  ...
  worker_egress_ip = {
    ...
    "amazonaws" = ["16.182.0.0/16","52.216.0.0/15","52.218.0.0/17"]
    // https://www.gstatic.com/ipranges/goog.json
    "google" = ["172.110.32.0/21","172.217.0.0/16","172.253.0.0/16"]
  }
}